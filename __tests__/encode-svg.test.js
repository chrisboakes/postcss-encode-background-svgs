...
test('svg to be encoded with style tags', () => {
    let svgValue = 'url(\'data:image/svg+xml, <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 178 157" style="enable-background:new 0 0 178 157;" xml:space="preserve"><style type="text/css">.st0{fill:#F90000;}</style><g><rect style="background-color: red" x="0.5" y="0.5" class="st0" width="177" height="156"/><path d="M177,1v155H1V1H177 M178,0H0v157h178V0L178,0z"/></g></svg>\')';
